# importing Libraries - https://www.mygreatlearning.com/blog/text-summarization-in-python/
import nltk
...
Summarization can be defined as a task of producing concise and fluent summary while preserving key
...
angle between vectors. The angle will be e if sentences are similar"""
